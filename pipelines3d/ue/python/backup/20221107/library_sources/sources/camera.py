...
def add_camera(path, sequence_name, create=False):
    if create:
        ...
        level_sequence = unreal.load_asset(f'{path}')
...
add_camera(path='/Game/')

add_camera('/Game/S8n-Experimental/MainExample/sequencer_script', )