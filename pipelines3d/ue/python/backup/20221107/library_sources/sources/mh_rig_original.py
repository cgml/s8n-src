# https://github.com/sagwl96/unreal-sequencer-python
import unreal
...
sk_mesh = level_util.get_selected_level_actors()
...
level_sequence = unreal.AssetTools.create_asset(asset_tools, asset_name = "LevelSequenceName", package_path = BASE_PATH, asset_class = unreal.LevelSequence, factory = unreal.LevelSequenceFactoryNew())
...
level_sequence = unreal.load_asset('/Game/S8n-Experimental/MainExample/sequence')
