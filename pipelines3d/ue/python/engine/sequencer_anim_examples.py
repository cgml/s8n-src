...
def export_anim_sequence(map_asset_path, sequencer_asset_path, anim_sequence):
	...
	# Set Options
	anim_export_options = unreal.AnimSeqOptionExport()
	anim_export_options.export_transforms = True
	anim_export_options.export_curves = True
	# Export
	print(bindings)
	unreal.SequencerTools.export_anim_sequence(world, sequence, anim_sequence, anim_export_options, bindings[0])
